  ...
  $(document).ready(function() {
    ...
    $("#artikel_select").on('change', function(){
      ...
      if(jQuery.inArray(artikel, articles) == -1){
        ...
        $('.blueTable > tbody:last-child').append('<tr id="'+artikel+'"><td>'+artikel+'</td><td>'+einheit2+'</td><td contenteditable style="text-align-last:center;">'+anz+'</td><td style="border-style:hidden;width:50px;"><input type="button" class="buttonToDelete" onclick="deleteData(\''+artikel+'\')" value="Löschen"></input></td></tr>');
      }
