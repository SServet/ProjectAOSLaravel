                ...
                <div id="page-content-wrapper">
                 <div class="container-fluid">
                    <div class="row">
                       ...
                       <br>
                       <br>
                       <p id="LabelContent">MITARBEITER > HINZUFÜGEN</p>
                       <hr>
                       <!-- Chosen -->
                       <!-- CSS -->
                       <link rel="stylesheet" href="{{ asset('assets/css/chosen.css') }}">
                        
                        <form action="{{ route('SubmitMitarbeiter') }}" method="post">
                          <table id="inputTable">
                            <tr>
                            ...
                            <tr>
                              ...
                              <td><input type="text" id="Adresse" class="form-control input-lg" name="adresse"></td>
                            </tr>
                            <tr>
